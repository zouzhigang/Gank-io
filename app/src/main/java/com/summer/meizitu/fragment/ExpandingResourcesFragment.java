 ...
 */
public class ExpandingResourcesFragment extends BaseListFragment<Benefit> {
    private int page = 1;

    public static Fragment newInstance() {
        ExpandingResourcesFragment f = new ExpandingResourcesFragment();
        return f;
    }

    public ExpandingResourcesFragment() {
    ...
    public void onRefresh(final int action) {
        ...
        Call<BaseModel<ArrayList<Benefit>>> call = api.getExpanding(20, page++);
