 ...
 */
public class RestVideoFragment extends BaseListFragment<Benefit> {
    private int page = 1;

    public static Fragment newInstance() {
        RestVideoFragment f = new RestVideoFragment();
        return f;
    }

    public RestVideoFragment() {
    ...
    public void onRefresh(final int action) {
        ...
        Call<BaseModel<ArrayList<Benefit>>> call = api.getRestVideo(20, page++);
